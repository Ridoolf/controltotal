...
function Hero() {
  ...
  return (
    <section id="inicio" className="hero">
      <div className="hero__fondo img-placeholder">
        [PENDIENTE — Foto hero: técnico en campo]
      </div>
      ...
      <div className="contenedor hero__contenido">
        <div className="hero__texto">
          ...
          <p className="hero__descripcion">{hero.descripcion}</p>
          <a href={whatsappUrl} className="hero__cta" target="_blank" rel="noopener noreferrer">
            <svg className="hero__cta-icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
